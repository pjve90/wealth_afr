...
hist(real_data5$aoc,
     xlim=c(0,80),
     ylim=c(0,85),
     col=alpha(hcl.colors(3,palette = "Zissou 1")[1],0.5),
     ...
     cex.main=1.5)
abline(h=0)
abline(v=mean(real_data5$aoc),lwd=2,lty=2,col="#DC3220")
abline(v=(mean(real_data5$aoc,na.rm=T)+sd(real_data5$aoc,na.rm=T)),lwd=2,lty=2,col="#005AB5")
abline(v=(mean(real_data5$aoc,na.rm=T)-sd(real_data5$aoc,na.rm=T)),lwd=2,lty=2,col="#005AB5")

hist(real_data5$afr,
     xlim=c(0,80),
     ylim=c(0,85),
     col=alpha(hcl.colors(3,palette = "Zissou 1")[2],0.5),
     main="Age distribution of\nage at first birth",
     xlab="Age",
     breaks=10,
     cex.axis=1.2,
     ...
     cex.main=1.5)
abline(h=0)
abline(v=mean(real_data5$afr,na.rm=T),lwd=2,lty=2,col="#DC3220")
abline(v=(mean(real_data5$afr,na.rm=T)+sd(real_data5$afr,na.rm=T)),lwd=2,lty=2,col="#005AB5")
abline(v=(mean(real_data5$afr,na.rm=T)-sd(real_data5$afr,na.rm=T)),lwd=2,lty=2,col="#005AB5")

hist(real_data5$aoc[which(is.na(real_data5$afr))],
     xlim=c(0,80),
     ylim=c(0,85),
     col=alpha(hcl.colors(3,palette = "Zissou 1")[3],0.5),
     main="Age distribution of\nchildless women",
     xlab="Age",
     breaks=24,
     cex.axis=1.2,
     ...
     cex.main=1.5)
abline(h=0)
abline(v=mean(real_data5$aoc[which(is.na(real_data5$afr))]),lwd=2,lty=2,col="#DC3220")
abline(v=(mean(real_data5$aoc[which(is.na(real_data5$afr))],na.rm=T)+sd(real_data5$aoc[which(is.na(real_data5$afr))],na.rm=T)),lwd=2,lty=2,col="#005AB5")
abline(v=(mean(real_data5$aoc[which(is.na(real_data5$afr))],na.rm=T)-sd(real_data5$aoc[which(is.na(real_data5$afr))],na.rm=T)),lwd=2,lty=2,col="#005AB5")
