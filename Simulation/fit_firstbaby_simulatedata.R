...
#current wealth
plot(c(30:1)~c(tab_real_beta_z[11:40,1]*tab_real_beta_sigma[1,1]),xlim=c(-2,2),main="Current\nwealth",yaxt="n",xlab=expression(beta~coefficients),ylab="Ages",pch=16)
...
#short-term wealth variability
plot(c(30:1)~c(tab_real_gamma_z[11:40,1]*tab_real_gamma_sigma[1,1]),xlim=c(-2,2),main="Short-term\nwealth variability",yaxt="n",xlab=expression(gamma~coefficients),ylab="Ages",pch=16)
axis(2,c(30:1),c(10:39))
clip(-2, 2, 0, 31)
abline(v=0,lty=2)
for (i in 11:40){
...
#long-term wealth variability
plot(c(30:1)~c(tab_real_delta_z[11:40,1]*tab_real_delta_sigma[1,1]),xlim=c(-2,2),main="Long-term\nwealth variability",yaxt="n",xlab=expression(delta~coefficients),ylab="Ages",pch=16)
axis(2,c(30:1),c(10:39))
clip(-2, 2, 0, 31)
abline(v=0,lty=2)
for (i in 11:40){
